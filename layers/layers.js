...
lyr_Amphoe_PROV_1.set('fieldAliases', {'AMP_CODE': 'AMP_CODE', 'PRV_CODE': 'PRV_CODE', 'AMP_NAME_T': 'AMP_NAME_T', 'AMP_NAME_E': 'AMP_NAME_E', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'TH_Provinc': 'TH_Provinc', 'TH_Provi_1': 'TH_Provi_1', 'Classlongun_longun': 'Classlongun_longun', });
lyr_Amphoe_PROV_1.set('fieldImages', {'AMP_CODE': 'Hidden', 'PRV_CODE': 'Hidden', 'AMP_NAME_T': 'TextEdit', 'AMP_NAME_E': 'TextEdit', 'Shape_Leng': 'Hidden', 'Shape_Area': 'Hidden', 'TH_Provinc': 'TextEdit', 'TH_Provi_1': 'TextEdit', 'Classlongun_longun': 'TextEdit', });
lyr_Amphoe_PROV_1.set('fieldLabels', {'AMP_NAME_T': 'no label', 'AMP_NAME_E': 'no label', 'TH_Provinc': 'no label', 'TH_Provi_1': 'no label', 'Classlongun_longun': 'no label', });
